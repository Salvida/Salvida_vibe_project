  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="h-20 flex items-center px-8 bg-white border-b border-slate-100 sticky top-0 z-20">
        ...
        <h2 className="text-xl font-bold text-slate-900 flex-1">{t('notifications.title')}</h2>
      ...
      <div className="flex-1 overflow-y-auto p-8">
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div>
            <h3 className="text-[10px] font-bold text-[#6b4691]/60 uppercase tracking-[0.2em] mb-6">
              {t('notifications.recentActivities')}
            </h3>
